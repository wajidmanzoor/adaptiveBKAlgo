...
#
# Build a profiling-enabled ReorderSib binary and run it on a curated set of
# larger, representative graphs from a dataset directory, printing the full
# profiling log for each individual run and saving each log to
# scripts/profile_logs/.
#
# Usage: ./scripts/profile_reordersib.sh [data_dir]
