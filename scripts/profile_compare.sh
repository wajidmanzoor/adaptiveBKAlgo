...
echo "Running Backtrack+ASC  (mode=1 ord=1 meth=0)..."
run_method "Backtrack+ASC" 1 1 0 "$TMPBT"

echo "Running Optimized+ASC  (mode=1 ord=1 meth=1)..."
run_method "Optimized+ASC" 1 1 1 "$TMPOPT"
