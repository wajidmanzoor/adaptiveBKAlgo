...
int main(int argc, const char *argv[]) {
  if (argc < 5 || argc > 13) {
    cout << "Usage: bk_algorithm <file> <mode> <ord> <meth> [hitSetLimit] [prune2] [sp1] [sp2] [sp3] [sp4] [sp5] [sp6]" << endl;
  ...
  bool prune2      = (argc > 6)  ? (bool)atoi(argv[6])  : true;
  bool sp1         = (argc > 7)  ? (bool)atoi(argv[7])  : true;
  bool sp2         = (argc > 8)  ? (bool)atoi(argv[8])  : true;
  bool sp3         = (argc > 9)  ? (bool)atoi(argv[9])  : true;
  bool sp4         = (argc > 10) ? (bool)atoi(argv[10]) : true;
  bool sp5         = (argc > 11) ? (bool)atoi(argv[11]) : true;
  bool sp6         = (argc > 12) ? (bool)atoi(argv[12]) : true;
  ...
  if (mode == 0) {
    ...
    ReorderSib reorder(g, static_cast<DegOrder>(ord),
                       ...
                       prune2, sp1, sp2, sp3, sp4, sp5, sp6);
